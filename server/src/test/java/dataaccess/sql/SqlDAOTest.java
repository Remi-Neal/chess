...
class SqlDAOTest {
    ...
    void gameList() {
        ...
        int id = 1;
        GameDataType gameData = new GameDataType(
                id,
                null,
                null,
                gameName,
    ...
    void updateGameData() {
        ...
        assertDoesNotThrow(() -> {
            gameSqlDAO.newGame(gameData);
            GameDataType newData = new GameDataType(
                    id,
                    "name",
                    null,
                    gameName,
        ...
        GameDataType currData = new GameDataType(
                id,
                whiteName,
                blackName,
                gameName,
    ...
    void testUpdateGameDataNames(){
        ...
        GameDataType currData = gameData;
        ...
        assertDoesNotThrow(()->{
            GameDataType newGame = new GameDataType(
                    id,
                    whiteName,
                    blackName,
                    newGameName,
