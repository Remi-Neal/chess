...
public class JoinGameService {
    public static void blackJoin(GameDAO gameDAO, String userName, int gameId) throws DataAccessException {
        ...
        GameDataType blackGame = new GameDataType(game.gameID(), game.whiteUsername(), userName, game.gameName(), game.chessGame());
    ...
    public static void whiteJoin(GameDAO gameDAO, String userName, int gameId) throws DataAccessException {
        ...
        GameDataType whiteGame = new GameDataType(game.gameID(), userName, game.blackUsername(), game.gameName(), game.chessGame());
